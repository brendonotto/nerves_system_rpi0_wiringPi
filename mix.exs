defmodule NervesSystemRpi0WiringPi.MixProject do
  use Mix.Project

  @app :nerves_system_rpi0_wiringPi
  ...
  defp bootstrap(args) do
    System.put_env("MIX_TARGET", "rpi0_wiringPi")
  ...
  defp package do
    [
      maintainers: ["Brendon Otto"],
      files: package_files(),
      licenses: ["Apache 2.0"],
      links: %{"Github" => "https://github.com/brendonotto/#{@app}"}
    ]
  end
